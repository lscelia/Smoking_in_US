...
In the past 4 years, it can be seen that the total sum of male smoker is higher that of female smoker. 

## Smokers among different age groups 
```{r,echo = FALSE}

#smoker's age proportion 
plot2 = bind_rows(a1,b1,c1,d1) %>% 
  count(year, agegroup) %>% 
  drop_na() %>% 
...
**Generally**, the smoker's proportion among the Asian, especially female,is the least. 
