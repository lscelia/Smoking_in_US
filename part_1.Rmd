...
```{r, warning = FALSE, message = FALSE}
#Plot 2020
plot4 = finding_smoking_dis(smoke_trend_2020)+labs(title = "Distribution of smoking among agegroup and race in year 2020", y = "proportion", caption = "Data from National Health Survey") + theme(axis.text.x = element_text(angle = 60, vjust = 0.5, hjust=1))
ggplotly(plot4)
```
...
```{r, warning = FALSE, message = FALSE}
#Plot 2019 
plot5 = finding_smoking_dis(smoke_trend_2019)+labs(title = "Distribution of smoking among agegroup and race in year 2019", y = "proportion", caption = "Data from National Health Survey") + theme(axis.text.x = element_text(angle = 60, vjust = 0.5, hjust=1))
ggplotly(plot5)
```
...
```{r, warning = FALSE, message = FALSE}
#Ploto 2017 
plot7 = finding_smoking_dis(smoke_trend_2017)+labs(title = "Distribution of smoking among agegroup and race in year 2017", y = "proportion", caption = "Data from National Health Survey") + theme(axis.text.x = element_text(angle = 60, vjust = 0.5, hjust=1))
