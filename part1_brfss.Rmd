...
###  Smoking Proportion and Cigarette Tax ?
```{r}
...
tax_2020_map
```
States in the southeast had higher smoking rates in the past 4 years.This may be explained by the states’ cigarette tax. By comparing the state’s tax  and the smoking rates, it can be observed that southeast has a comparatively low cigarette tax when compared to other areas. 
