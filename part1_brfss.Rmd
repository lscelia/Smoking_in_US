...
# to see the states with the largest proportion change 
  clean_brfss %>% 
   ...
   pivot_wider(
    ...
    arrange(change) %>%
    select(change, locationdesc, old, new)
...
```
State with the largest decrease of smoking proportion by comparing year 2020 and 2017
Congratulation to the state District of Columbia! It has the largest decrease in the smokers' proportion in the  
