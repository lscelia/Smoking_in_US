...
### Smoking proportion in Different States
```{r, include=FALSE}
US = map_data("state") 
...
(map17|map18)/
  (map19|map20)
```
From the plot, the more yellowish the dot,the higher the smoker's proportion.Conversely, the greener the dot, the lower th smoker's proportion of the state. 
...
knitr::kable(three_highest, 
             digits = 3,
             col.names = c("Year", "State", "Smoking Proportion"))
```

**West Virginia**, **Kentucky**, and **Tennessee** have a comparatively high smoking proportion. In year 2018, and 2020, West Virginia has the highest smoking proportion in the U.S, which were 21.2% and 20.2% respectively. For 2019, it has the second highest smoking proportion (20.1%), which was slightly lower than that of Kentucky by approximately 0.5%.
...
Tennessee also always occupies a seat in top 3 when it comes to the highest smoking proportion. Its proportions were 21.2%, 20.5%,19.3%, 19.4% in year 2017,2018,2019 and 2020 respectively.
