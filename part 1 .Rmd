...
```{r,echo = FALSE}
#Plot 2020
plot4 = finding_smoking_dis(smoke_trend_2020)+labs(title = " Distribution of smoking among agegroup and race in year 2020")
ggplotly(plot4)
```

```{r,echo = FALSE}
#Plot 2019 
plot5 = finding_smoking_dis(smoke_trend_2019)+labs(title = " Distribution of smoking among agegroup and race in year 2019")
ggplotly(plot5)
```

```{r,echo = FALSE}
#Plot 2018 
plot6 = finding_smoking_dis(smoke_trend_2018)+labs(title = " Distribution of smoking among agegroup and race in year 2018")
ggplotly(plot6)
```

```{r,echo = FALSE}
#Ploto 2017 
plot7 = finding_smoking_dis(smoke_trend_2017)+labs(title = " Distribution of smoking among agegroup and race in year 2017")
ggplotly(plot7)
```
