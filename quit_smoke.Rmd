...
Here is the amount of tax ($ per pack) for 58 regions in the US (50 states and 8 territories that belongs to the U.S.). From the plot, American Samoa (AS) has the highest cigarette tax, with 6 dollars per pack, followed by Puerto Rico (PR), Palau (PW), and District Colombia (DC). These four regions are all outside of 50 states. Among 50 states in the country, New York (NY) has the highest tax, with 4.35 dollars per pack. 
