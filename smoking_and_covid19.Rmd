...
```{r smoker_by_disability, echo = FALSE}
disability_df =
  adult_smoke %>%
  filter(year == 2020) %>%
...
cancer_df %>%
  ggplot(aes(x = year, y = proportion, fill = smoke)) +
  geom_bar(position = "stack", stat = "identity") +
  labs(
    title = "The Proportion of Current Smokers With Cancer",
...
asthma_df %>%
  ...
  geom_bar(position = "stack", stat = "identity") +
  labs(
    title = "The Proportion of Current Smokers With Asthma",
    subtitle = "Compare 2019 with 2020",
    x = "Year",
    y = "Proportion",
    caption = "Data from the National Health Interview Survey"
...
copd_df %>%
  ...
  geom_bar(position = "stack", stat = "identity") +
  labs(
    title = "The Proportion of Current Smokers With COPD",
    subtitle = "Compare 2019 with 2020",
    x = "Year",
    y = "Proportion",
    caption = "Data from the National Health Interview Survey"
...
### !!!!!!!! Current smoker upupup 
dementia_df %>%
  ggplot(aes(x = year, y = proportion, fill = smoke)) +
  geom_bar(position = "stack", stat = "identity") +
  labs(
    title = "The Proportion of Current Smokers With Dementia",
    subtitle = "Compare 2019 with 2020",
    x = "Year",
    y = "Proportion",
    caption = "Data from the National Health Interview Survey"
...
diabetes_df %>%
  ...
  geom_bar(position = "stack", stat = "identity") +
  labs(
    title = "The Proportion of Current Smokers With Type 1/2 Diabetes",
    subtitle = "Compare 2019 with 2020",
    x = "Year",
    y = "Proportion",
    caption = "Data from the National Health Interview Survey"
...
heart_disease_df %>%
  ...
  geom_bar(position = "stack", stat = "identity") +
  labs(
    title = "The Proportion of Current Smokers With Heart Disease",
    subtitle = "Compare 2019 with 2020",
    x = "Year",
    y = "Proportion",
    caption = "Data from the National Health Interview Survey"
...
hypertension_df %>%
  ...
  geom_bar(position = "stack", stat = "identity") +
  labs(
    title = "The Proportion of Current Smokers With Hypertension",
    subtitle = "Compare 2019 with 2020",
    x = "Year",
    y = "Proportion",
    caption = "Data from the National Health Interview Survey"
...
stroke_df %>%
  ...
  geom_bar(position = "stack", stat = "identity") +
  labs(
    title = "The Proportion of Current Smokers With Stroke",
    subtitle = "Compare 2019 with 2020",
    x = "Year",
    y = "Proportion",
    caption = "Data from the National Health Interview Survey"
...
mental_df %>%
  ...
  geom_bar(position = "stack", stat = "identity") +
  labs(
    title = "The Proportion of Current Smokers With Mental Disease",
    subtitle = "Compare 2019 with 2020",
    x = "Year",
    y = "Proportion",
    caption = "Data from the National Health Interview Survey"
...
bmi_df %>%
  ...
  geom_bar(position = "stack", stat = "identity") +
  labs(
    title = "The Proportion of Current Smokers With Obesity",
    subtitle = "Compare 2019 with 2020",
    x = "Year",
    y = "Proportion",
    caption = "Data from the National Health Interview Survey"
...
preganant_df %>%
  ...
  geom_bar(position = "stack", stat = "identity") +
  labs(
    title = "The Proportion of Current Smokers With Pregnancy",
    subtitle = "Compare 2019 with 2020",
    x = "Year",
    y = "Proportion",
    caption = "Data from the National Health Interview Survey"
